          ...
          {allPicks.filter(pick => pick.week === currentWeek).length === 0 ? (
            ...
            <div className="picks-table-container">
              <table className="picks-table">
                <thead>
                  <tr>
                    <th rowSpan="2" style={{minWidth: '75px', maxWidth: '85px', width: '80px', fontSize: '0.8rem', padding: '4px', whiteSpace: 'normal', wordWrap: 'break-word'}}>Player</th>
                    {currentWeekData.games.map(game => (
                    ...
                    <th rowSpan="2" style={{backgroundColor: '#e8f5e9', fontWeight: 'bold', color: '#090909ff', minWidth: '50px', maxWidth: '50px', width: '50px', fontSize: '0.65rem', padding: '4px 2px', lineHeight: '1.1'}}>
                    ...
                    {currentWeek === 'superbowl' ? (
                      ...
                      <th rowSpan="2" style={{backgroundColor: '#f8f9fa', fontWeight: 'bold', color: '#000', minWidth: '55px', maxWidth: '55px', width: '55px', padding: '4px 2px', fontSize: '0.7rem'}}>
                    ...
                    <th rowSpan="2" style={{minWidth: '110px', maxWidth: '110px', width: '110px', fontSize: '0.65rem', padding: '4px 2px'}}>Submitted</th>
                  </tr>
                      ...
                      return (
                        <tr key={idx} className={isRNGPick ? 'rng-pick-row' : ''}>
                          <td className="player-name">
                            ...
                            {isRNGPick && (
                              <span 
                                className="rng-indicator"
                                title="Picks generated by Pool Manager (missed deadline)"
                              >
                                🎲
                              </span>
                            )}
