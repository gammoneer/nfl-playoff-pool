  ...
  if (prizeInfo.week === 'all') {
    ...
    Object.keys(weekData).forEach(weekKey => {
      ...
      weekGames.forEach(game => {
        ...
        // CRITICAL FIX: Check if scores are valid numbers, not just defined
        if (score) {
          const team1Score = parseInt(score.team1);
          const team2Score = parseInt(score.team2);
          // Only count as complete if BOTH scores are valid numbers
...
/**
 * Main Leader Display Component - WITH COLLAPSIBLE WEEKS
 */
function LeaderDisplay({ allPicks, actualScores, games, officialWinners, weekData }) {
  ...
  const weekHeaderStyle = (isExpanded) => ({
    cursor: 'pointer',
    userSelect: 'none',
    display: 'flex',
    alignItems: 'center',
    ...
    <div className="leaders-section">
      ...
      <div style={{marginBottom: '20px'}}>
        <h3 
          ...
          style={weekHeaderStyle(expandedPrizeWeeks['Week 1'])}
          onMouseEnter={(e) => {
      ...
      <div style={{marginBottom: '20px'}}>
        <h3 
          ...
          style={weekHeaderStyle(expandedPrizeWeeks['Week 2'])}
          onMouseEnter={(e) => {
            e.currentTarget.style.transform = 'translateX(5px)';
            e.currentTarget.style.boxShadow = '0 4px 15px rgba(102, 126, 234, 0.4)';
          }}
      ...
      <div style={{marginBottom: '20px'}}>
        <h3 
          ...
          style={weekHeaderStyle(expandedPrizeWeeks['Week 3'])}
          onMouseEnter={(e) => {
            e.currentTarget.style.transform = 'translateX(5px)';
            e.currentTarget.style.boxShadow = '0 4px 15px rgba(102, 126, 234, 0.4)';
          }}
      ...
      <div style={{marginBottom: '20px'}}>
        <h3 
          ...
          style={weekHeaderStyle(expandedPrizeWeeks['Week 4'])}
          onMouseEnter={(e) => {
            e.currentTarget.style.transform = 'translateX(5px)';
            e.currentTarget.style.boxShadow = '0 4px 15px rgba(102, 126, 234, 0.4)';
          }}
      ...
      <div style={{marginBottom: '20px'}}>
        <h3 
          ...
          style={weekHeaderStyle(expandedPrizeWeeks['Grand Prizes'])}
          onMouseEnter={(e) => {
            e.currentTarget.style.transform = 'translateX(5px)';
            e.currentTarget.style.boxShadow = '0 4px 15px rgba(102, 126, 234, 0.4)';
          }}
