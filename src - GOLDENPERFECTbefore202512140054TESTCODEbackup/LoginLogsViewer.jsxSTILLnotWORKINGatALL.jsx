                  ...
                  <tr style={{background: '#fff3cd', borderBottom: '3px solid #ffc107'}}>
                    <td colSpan="7" style={{
                      ...
                      <div style={{marginBottom: '15px'}}>
                        <strong style={{fontSize: '1.1rem', color: '#856404'}}>🐛 DEBUG - First Log Data:</strong>
                      </div>
                      <div style={{background: '#fff', padding: '15px', borderRadius: '6px', border: '1px solid #ffc107'}}>
                        <div><strong>ID:</strong> {filteredLogs[0].id}</div>
                        <div><strong>Timestamp:</strong> {filteredLogs[0].timestamp} → {new Date(filteredLogs[0].timestamp).toLocaleString()}</div>
                        <div><strong>Player Code:</strong> "{filteredLogs[0].playerCode}"</div>
                        <div><strong>Player Name:</strong> "{filteredLogs[0].playerName}"</div>
                        <div><strong>Success:</strong> {String(filteredLogs[0].success)}</div>
                        <div><strong>Browser:</strong> "{filteredLogs[0].browser}"</div>
                        <div><strong>Device:</strong> "{filteredLogs[0].device}"</div>
                        <div><strong>Error Message:</strong> "{filteredLogs[0].errorMessage || 'none'}"</div>
                      </div>
                      <details style={{marginTop: '15px'}}>
                        <summary style={{cursor: 'pointer', color: '#856404', fontWeight: 'bold'}}>Show Full JSON</summary>
                        <pre style={{
                          margin: '10px 0', 
                          overflow: 'auto', 
                          background: '#f8f9fa', 
                  ...
                  >
                    <td style={{
                      ...
                      <span style={{
                        ...
                        {log.timestamp ? (
                          <>
                            <div style={{color: '#000 !important', marginBottom: '5px'}}>
                            ...
                            <small style={{color: '#666 !important', fontSize: '11px !important'}}>[{log.timestamp}]</small>
                          </>
                        ) : '⚠️ No timestamp'}
                      </span>
                    </td>
                    <td style={{
                      padding: '15px !important', 
                      fontSize: '16px !important', 
                      fontFamily: 'Courier, monospace !important', 
                      fontWeight: 'bold !important',
                    ...
                    <td style={{
                      ...
                      <span style={{color: '#FF0000 !important', fontWeight: 'bold !important'}}>
                        {log.errorMessage || '-'}
                      </span>
                    </td>
                    <td style={{
                      ...
                      fontSize: '16px !important',
                      color: '#000000 !important',
                      backgroundColor: '#CCCCFF !important',
                      border: '2px solid #000 !important',
                      fontWeight: 'bold !important',
                      opacity: '1 !important',
                      filter: 'none !important'
                    }}>
                      <span style={{color: '#000000 !important', fontWeight: 'bold !important', fontSize: '16px !important'}}>
                    ...
                    <td style={{
                      ...
                      fontSize: '16px !important',
                      color: '#000000 !important',
                      backgroundColor: '#FFCCFF !important',
                      border: '2px solid #000 !important',
                      fontWeight: 'bold !important',
                      opacity: '1 !important',
                      filter: 'none !important'
