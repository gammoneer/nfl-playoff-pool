...
const PLAYOFF_WEEKS = {
  ...
  conference: {
    ...
    games: [
      { id: 11, team1: "AFC Winner B", team2: "AFC Winner A" },
      { id: 12, team1: "NFC Winner B", team2: "NFC Winner A" }
    ]
  },
  superbowl: {
                ...
                <thead>
                  <tr>
                    ...
                    <th rowSpan="2" style={{textAlign: 'center'}}>
                      ...
                      Submitted
                      <div style={{fontSize: '0.95rem', color: '#010101ff', fontWeight: 'bold', marginTop: '2px'}}>
                        (PST)
                      </div>
                      <div style={{marginTop: '4px'}}>
                        <button
