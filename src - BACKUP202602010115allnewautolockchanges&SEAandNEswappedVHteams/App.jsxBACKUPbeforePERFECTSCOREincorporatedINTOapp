...
//    }
   ...
   */
  const savePrizePool = async (totalFees, numberOfPlayers, entryFee, perfectScoreBonusEnabled, perfectScorePrizeAmount, perfectScoreCutoff) => {
    try {
              ...
              <div style={{
                ...
                <div style={{
                  ...
                  <label style={{
                    ...
                    />
                    <span>🎯 Enable Perfect Score Prizes</span>
                  </label>
                  <div style={{fontSize: '0.85rem', color: '#856404', marginBottom: '15px', marginLeft: '32px'}}>
                    Award prizes for players who predict the exact final score of playoff games.
                  ...
                  <div style={{marginLeft: '32px'}}>
                    <div style={{marginBottom: '15px'}}>
                      ...
                      <div style={{fontSize: '0.8rem', color: '#856404', marginTop: '5px'}}>
                        Total $ amount for perfect score prizes (e.g., $60 from $560 total pool)
                      </div>
                    </div>
                  ...
                  <div style={{
                    ...
                    💡 Example: $60 prize pool, 30 cutoff. If 6 perfect scores total → each gets $10. If 31+ perfect scores → nobody gets paid, $60 goes to main prizes.
                  </div>
                </div>
                ...
                <div style={{display: 'flex', gap: '10px'}}>
                  ...
                  <button
                    onClick={() => {
                      ...
                      savePrizePool(totalFees, numberOfPlayers, entryFee, perfectScoreBonusEnabled, perfectScorePrizeAmount, perfectScoreCutoff);
                    }}
                    style={{
                      flex: '1',
                      padding: '14px',
